...
def home():
    ...
    <head>
        ...
        <style>
            ...
            h1 {
                font-size: 48px;
                background: linear-gradient(90deg, #00ffea, #5865f2, #ff73fa);
    ...
    <body>
        <div class="container">
            ...
            <div class="features">
                <div class="feature">
                    <h3>🚀 Instant Join</h3>
                    <p>One click to join any server the bot is in.</p>
                </div>
                <div class="feature">
                    <h3>🛡️ Safe & Secure</h3>
                    <p>Only adds you when you authorize. Full control.</p>
                </div>
                <div class="feature">
                    <h3>💰 100%% Free</h3>
                    <p>No payments, no limits. Forever free.</p>
                </div>
            </div>
            
            <h2>How It Works</h2>
            <p>
                1. Click the button above and authorize the bot<br>
                2. Server owners use <code>/join</code> command with their server ID<br>
                3. All authorized members (like you!) get added instantly<br>
                4. Enjoy being part of exclusive communities!
            </p>
...
def callback():
    # ... [keep all the token code the same] ...
    return """
    <!DOCTYPE html>
    <html>
    <head>
